...
_CHECKS = (
    ...
    _CheckSpec("critical-module-branch-coverage", "core", "tests/test_v07_release_gate.py::test_critical_module_branch_coverage", "scripts/check_critical_coverage.py"),
    _CheckSpec("fault-before-claim", "core", "tests/test_v07_execution_attempts.py::test_fault_at_every_state_is_durable", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-after-claim", "core", "tests/test_v07_execution_attempts.py::test_fault_at_every_state_is_durable", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-after-cash-reservation", "core", "tests/test_v04_payments.py::test_manager_reserve_is_durably_idempotent_and_recovers_lost_response", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-after-capacity-reservation", "core", "tests/test_v07_capacity.py::test_capacity_reservation_release_and_replay_are_atomic", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-before-external-invocation", "core", "tests/test_v07_execution_attempts.py::test_fault_at_every_state_is_durable", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-after-app-server-turn-start", "core", "tests/test_v07_execution_attempts.py::test_managed_crash_is_indeterminate_and_same_decision_cannot_duplicate", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-during-streamed-output", "core", "tests/test_codex_subscription_adapter.py::test_turn_failure_modes_fail_closed", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-before-validation", "core", "tests/test_v07_execution_attempts.py::test_fault_at_every_state_is_durable", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-during-settlement", "core", "tests/test_v04_payments.py::test_settlement_adapter_failure_preserves_indeterminate_reservation", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-after-partial-release", "core", "tests/test_x402_capacity_binding.py::test_local_batch_conformance_is_complete_and_offline", "reports/v07/fault-injection.json"),
    _CheckSpec("fault-during-recovery", "core", "tests/test_v07_execution_attempts.py::test_recovery_inspects_external_state_and_never_retries_invoking_attempt", "reports/v07/fault-injection.json"),
